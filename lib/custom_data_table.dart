...
class CustomDataRow {
  ...
  final Function(bool,[String]) onSelectChanged;
...
class CustomDataTable extends StatefulWidget{
  ...
  CustomDataTableState activeState;
  ...
  CustomDataTable({
    ...
    @required this.rows,
        ...
        super(key: key);
  CustomDataTableState createState()=> CustomDataTableState(columns: this.columns,rows: this.rows,onSelectAll: this.onSelectAll);
}
...
//print("got here");
        if ((row.onSelectChanged != null) )
          row.onSelectChanged(row.selected=checked,row.idTag);
      }
      setState(() {
  ...
  Widget _buildDataCell({
    ...
    if (onTap != null) {
      ...
      label = TableRowInkWell(
        ...
        child: label,// check this out, to make the entire row appear pressed
      );
    }
    return label;
  }
      ...
      for (CustomDataRow row in rows) {
        tableRows[rowIndex].children[0] = _buildCheckbox(
          ...
          onRowTap: () {
           ...
           return  row.onSelectChanged(row.selected,row.idTag) ;
            }
            else
              return null ;},
    ...
    for (int dataColumnIndex = 0; dataColumnIndex < columns.length; dataColumnIndex += 1) {
      ...
      for (CustomDataRow row in rows) {
        ...
        tableRows[rowIndex].children[displayColumnIndex] = _buildDataCell(
          ...
          onTap:()=> cell.onTap!=null?cell.onTap(cell.idTag):null,//
          ...
          onSelectChanged:  () {
            ...
            if(row.onSelectChanged != null)  {
              ...
              //return  row.onSelectChanged(row.selected) ;
            }
            else
              return null ;},
        );
